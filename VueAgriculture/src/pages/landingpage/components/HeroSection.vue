...
<template>
  <div class="flex xs:flex-col sm:flex-col flex-row-reverse gap-4 2xl:gap-20 2xl:px-16 px-12 xs:px-4 py-4 bg-neutral-content place-content-between border border-b-2 border-base-200">
    <img src="/src/assets/image/michael-yero-8S2RGfb9GXc-unsplash.jpg" alt="" class="rounded-xl w-full h-full md:w-80 md:h-80 lg:w-96 lg:h-96 2xl:w-1/2 2xl:h-[640px] object-cover object-center">
    <div class="flex flex-col 2xl:gap-6 gap-4 place-content-center 2xl:w-[640px]">
