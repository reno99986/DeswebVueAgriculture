...
<template>
  <main
    class="flex text-center  xs:flex-col sm:flex-col flex-row-reverse gap-4 2xl:gap-20 xl:gap-20 2xl:px-16 xl:px-16 px-12 xs:px-4 py-4 emerald:bg-neutral place-content-between border border-b-2 border-base-200">
    ...
    <div class="flex items-center  flex-col 2xl:gap-6 gap-4 place-content-center ">
      ...
      <p class="prose-lg xs:prose-sm sm:prose-base md:prose-base text-center 2xl:prose-xl">
        ...
        Klik pada setiap judul pertanyaan untuk menampilkan jawabannya. Jika tidak menemukan jawaban yang Anda cari,
        silakan hubungi kami.
      </p>
      <button class="btn btn-secondary w-1/3 xs:w-3/5 md:w-1/2 p-0 2xl:prose-lg">
        <RouterLink to="/services">Hubungi Kami</RouterLink>
      </button>
    </div>
  </main>
</template>